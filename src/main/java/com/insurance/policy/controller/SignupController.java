...
public class SignupController extends BaseController {
    ...
    public ApiResponseDto<AuthResponseDto> registerUser(
        ...
        return handleRequest(getControllerName() + "registerUser",
                context, () -> authService.register(context.getRequestId(), request)
        );
    }
}